  ...
  server.registerTool(
    "create_notebook",
    {
      ...
      inputSchema: {
        ...
        contentPath: z.string().optional().describe("Absolute or cwd-relative path to a JSON file whose contents become the notebook content. Provide exactly one of content or contentPath."),
      },
    },
    ...
    "update_notebook",
    {
      ...
      inputSchema: {
        ...
        content: z.record(z.unknown()).optional()
          .describe("New notebook content as a JSON object (optional)."),
        contentPath: z.string().optional().describe("Absolute or cwd-relative path to a JSON file whose contents become the new notebook content. Mutually exclusive with content."),
      },
    },
