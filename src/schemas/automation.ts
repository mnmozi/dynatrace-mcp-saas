...
export const workflowSchema = z
  .object({
    title: z
      ...
      .min(1)
      .max(200)
      .describe("Workflow title (required, 1–200 chars)."),
    description: z
      .string()
      .optional()
    ...
    tasks: z
      ...
      .optional()
      .describe(
        "Map of task names to task definitions. Each task is an object per the AutomationEngine spec.",
      ),
    trigger: z
      .record(z.unknown())
      .optional()
    ...
    isPrivate: z
      .boolean()
      .optional()
      .describe("Whether the workflow is private (default: true)."),
    isDeployed: z
      .boolean()
      .optional()
      .describe("Whether the workflow is deployed/active (default: true)."),
    actor: z
      .string()
      .max(36)
      .optional()
      .nullable()
      .describe("Service account or user running the workflow tasks."),
    owner: z
      .string()
      .optional()
      .describe("UUID of the owner (user or group) of this workflow."),
    ownerType: z
      .string()
      .optional()
      .describe("Owner type: 'USER' or 'GROUP'."),
    schemaVersion: z
      .number()
      .int()
      .optional()
      .describe("Schema version integer."),
    type: z
      .string()
      .optional()
      .describe("Workflow type, e.g. 'simple' or 'standard'."),
    input: z
      .record(z.unknown())
      .optional()
      .describe("Workflow-level input parameter definitions."),
    ...
    result: z
      ...
      .optional()
      .nullable()
      .describe("DQL expression that produces the workflow result."),
    id: z
      .string()
      .optional()
      .describe("Workflow UUID (omit on create; required on update via path param)."),
  })
  .passthrough();
